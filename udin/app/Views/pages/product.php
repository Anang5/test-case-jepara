...
<div class="p-3 mb-2 bg-light text-dark">
    <div class="container">
        <div class="row col-6 col-lg-6">
            ...
            <div class="col-4 col-lg-4  mb-4 mb-lg-3">
                <div class="card" style="width: 18rem;">
                    <img src="https://images.unsplash.com/photo-1625943555419-56a2cb596640?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80" class="img-fluid ukuran" alt="...">
                    <div class="card-body">
                ...
                <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <h4><span class="fw-bold text-center">$12</span> USD</h3>
                            <h4><span class="fw-bold text-center">Drink</h3>
                                    <div class="d-inline-block">
                                        <a href="product/drink.php" class="btn btn-sm btn-outline-dark border text-decoration-none">Cek This Product</a>
                                    </div>
                    </div>
                </div>
            </div>
            <div class="col-4 col-lg-4  mb-4 mb-lg-3">
                <div class="card" style="width: 18rem;">
                    <img src="https://images.unsplash.com/photo-1453824979084-c8fd42932378?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80" class="img-fluid ukuran" alt="...">
                    <div class="card-body">
